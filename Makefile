# This Makefile is for the Algorithm::Statistic extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Algorithm/Statistic.pm]
#     AUTHOR => [q[Igor Karbachinsky]]
#     BUILD_REQUIRES => {  }
#     CC => q[g++]
#     CONFIGURE_REQUIRES => {  }
#     DEFINE => q[]
#     INC => q[-I include/ -std=c++11]
#     LD => q[g++]
#     LIBS => [q[]]
#     NAME => q[Algorithm::Statistic]
#     OBJECT => q[$(O_FILES)]
#     PREREQ_PM => { Exporter=>q[5.57], Test::More=>q[0], Test::Requires=>q[0] }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/Algorithm/Statistic.pm]
#     XSOPT => q[-C++]
...
XS_FILES = Statistic.xs
C_FILES  = Statistic.c
O_FILES  = Statistic.o
H_FILES  = ppport.h
MAN1PODS = 
MAN3PODS = lib/Algorithm/Statistic.pm
...
TO_INST_PM = lib/Algorithm/Statistic.pm

PM_TO_BLIB = lib/Algorithm/Statistic.pm \
	blib/lib/Algorithm/Statistic.pm
...
XSPROTOARG = 
XSUBPPDEPS = /usr/share/perl/5.14/ExtUtils/typemap /usr/share/perl/5.14/ExtUtils$(DFSEP)xsubpp
XSUBPPARGS = -C++ -typemap "/usr/share/perl/5.14/ExtUtils/typemap"
XSUBPP_EXTRA_ARGS =
...
DISTNAME = Algorithm-Statistic
DISTVNAME = Algorithm-Statistic-0.01
...
# Algorithm::Statistic might depend on some other libraries:
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) -u \
	  lib/Algorithm/Statistic.pm $(INST_MAN3DIR)/Algorithm::Statistic.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''different statistical algorithms library'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '  - '\''Igor Karbachinsky'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Algorithm-Statistic' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "different statistical algorithms library",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "Igor Karbachinsky"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Algorithm-Statistic",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>different statistical algorithms library</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Igor Karbachinsky</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Algorithm/Statistic.pm blib/lib/Algorithm/Statistic.pm 
